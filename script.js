const apiKey = "3de975dfa607299b06121c0e5ea49edc"
...
function favoriteButtonPressed(event, movie) {
  const favoriteState = {
    favorited: 'imgs/heart-fill.svg',
    notFavorited: 'imgs/heart.svg'
  }
...
function renderMovie(movie) {
  ...
  favoriteImage.src = isFavorited ? 'imgs/heart-fill.svg' : 'imgs/heart.svg'
